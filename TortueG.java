...
public class TortueG {
    ...
    */
    ...
    /**
     * Efface le canvas et réinitialise la tortue ˆ sa position de depart
     *
     */
    public void reset() {
        CanvasTortue.reset();
    ...
    /**
     * Méthode permettant ˆ la tortue d'avancer dans la direction fixée
     * de 0 ˆ 3, de l'Est vers le Nord
     * La méthode réaffiche la tortue aprs le mouvement
